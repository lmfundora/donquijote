        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="https://www.instagram.com/donquijote_rest?utm_source=qr&igsh=MXczYTZxYmhwbmxtcw=="
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full flex items-center justify-center text-xs hover:opacity-70 transition-opacity"
                style={{
                  background:
              ...
              <a
                href="https://whatsapp.com/channel/0029VbCwjQx3rZZdk6HP7L0b"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 bg-[#25D366] rounded-full flex items-center justify-center text-xs hover:opacity-70 transition-opacity"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
